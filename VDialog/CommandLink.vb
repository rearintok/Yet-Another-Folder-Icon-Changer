...
#Region " Fields and Properties "
    ...
    Private ReadOnly _pressedBorder As Color
    Private ReadOnly _pressedBackground As Color
    Private ReadOnly _activeBorderHot1 As Color
    Private ReadOnly _activeBorderHot2 As Color
    Private ReadOnly _activeBorderCold As Color
    Private ReadOnly _hoveredBorder1 As Color
    Private ReadOnly _hoveredBorder2 As Color
    Private ReadOnly _hoveredBorder3 As Color
    Private ReadOnly _hoveredBackground1 As Color
    Private ReadOnly _hoveredBackground2 As Color
    Private ReadOnly _hoveredBackground3 As Color
