...
Friend Class Windows7ColorTable
	...
	Private Shared _checkBack As Color = Color.FromArgb(234, 242, 250)
	...
	Private Shared _imageMargin As Color = Color.FromArgb(241, 241, 241)
