...
#Region "Stream Utilities"
        ...
        Public Shared Function ReadStructure(Of T As Structure)(inputStream As Stream) As T
        ...
        Public Shared Sub WriteStructure(Of T As Structure)(outputStream As Stream, [structure] As T)
            Dim size As Integer = Marshal.SizeOf(GetType(T))
            Dim buffer As Byte() = New Byte(size - 1) {}
            Dim ptr As IntPtr = Marshal.AllocHGlobal(size)
